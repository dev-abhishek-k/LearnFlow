...
class SectionRepository{
    async createSection(data:Prisma.SectionUncheckedCreateInput):Promise<Section>{
    ...
    async updateSection(id:string,data:Prisma.SectionUpdateInput):Promise<Section | null>{
